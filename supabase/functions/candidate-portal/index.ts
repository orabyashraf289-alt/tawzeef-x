...
serve(async (req) => {
  ...
  // Rate limit: 10 requests/min per IP — هذه دالة عامة بدون JWT وبتقدر ترجع بيانات
  // مرشحين حقيقية (اسم/مهارات/حالة) لو حد جرّب يخمّن أكواد تتبع أو أرقام تليفون جزئية
