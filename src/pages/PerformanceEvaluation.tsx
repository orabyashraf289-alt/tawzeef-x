  ...
  const { data: dbEvals, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      if (!data || data.length === 0) {
        const seededEvals = [
          {
            ...
            reviewer_name: "أحمد الحربي",
            reviewer_name_en: "Ahmad Al-Harbi",
            relationship: "self",
            productivity: 9,
            leadership: 7,
            teamwork: 8.5,
            technical: 9.5,
            communication: 8,
            comment: "تقييم ذاتي لمستوى الإنجاز الحالي.",
            user_id: user.id
          },
          {
            evalee_name: "أحمد الحربي",
          ...
          },
          {
            ...
            evalee_role: "مهندس واجهات أمامية أول",
            evalee_role_en: "Senior Frontend Engineer",
            reviewer_name: "خالد منصور",
            reviewer_name_en: "Khaled Mansour",
            relationship: "peers",
            productivity: 8,
            leadership: 7.5,
            teamwork: 9,
            technical: 9.2,
            communication: 8.2,
            comment: "أحمد متعاون جداً ولديه مهارة فنية متميزة في حل مشكلات الأداء بالواجهات.",
            user_id: user.id
          },
          {
            evalee_name: "أحمد الحربي",
            ...
            evalee_role: "مهندس واجهات أمامية أول",
            evalee_role_en: "Senior Frontend Engineer",
            reviewer_name: "فريق الواجهات",
            reviewer_name_en: "UI Team",
            ...
            technical: 9,
            communication: 8.4,
            comment: "داعم جداً للزملاء الأقل خبرة وينقل المعرفة بسخاء.",
            user_id: user.id
          },
          {
            ...
            reviewer_name_en: "Sarah Al-Otaibi",
            relationship: "self",
            productivity: 8,
            leadership: 8,
            teamwork: 9.5,
            technical: 7.5,
            communication: 9.5,
            comment: "أسعى دائماً لتحسين قنوات التواصل داخل الشركة.",
            user_id: user.id
          },
          {
            evalee_name: "سارة العتيبي",
          ...
          {
            evalee_name: "خالد منصور",
            evalee_name_en: "Khaled Mansour",
            evalee_role: "مطور واجهات خلفية أول",
            evalee_role_en: "Senior Backend Developer",
            reviewer_name: "خالد منصور",
            reviewer_name_en: "Khaled Mansour",
            relationship: "self",
            productivity: 9.5,
            ...
            technical: 9.8,
            communication: 7,
            comment: "تطوير وصيانة البنية التحتية بنجاح.",
            user_id: user.id
          },
          {
            evalee_name: "خالد منصور",
            ...
            technical: 9.6,
            communication: 7.2,
            comment: "قدرات خالد الهندسية استثنائية، لكن يحتاج لزيادة مشاركة التحديثات مع الفريق بشكل أبكر.",
            user_id: user.id
          }
        ];
        ...
        if (insertError) {
          console.error("Error seeding evaluations:", insertError);
          return seededEvals;
        }
        return inserted || [];
      }
