...
async function createHabeebCompanyOwner() {
  console.log("Registering Habeeb Company Owner (habeeb@tawzeefx.com)...");
  const { data, error } = await supabase.auth.signUp({
    email: "habeeb@tawzeefx.com",
    password: "Habeeb@2026!",
    options: {
      data: {
        full_name: "مجموعة عبد الرحمن الحبيب",
        company_name: "مجموعة عبد الرحمن الحبيب",
        role: "recruiter"
      }
    }
  });
