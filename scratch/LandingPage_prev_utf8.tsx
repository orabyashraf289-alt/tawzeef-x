  ...
  return (
    <div className="relative w-full max-w-md mx-auto">
      ...
      >
        ...
        <div>
          <div className="text-[11px] font-bold text-foreground">┘à╪│╪¬┘å╪»╪º╪¬ PDF / Word</div>
          <div className="text-[9px] text-muted-foreground">╪º╪│╪¬╪«╪▒╪º╪¼ ┘ü┘ê╪▒┘è ┘ä╪¿┘è╪º┘å╪º╪¬ ╪º┘ä╪│┘è╪▒╪⌐</div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div>
          <div className="text-[11px] font-bold text-foreground">┘à┘é╪º╪¿┘ä╪⌐ ┘ü┘è╪»┘è┘ê HD</div>
          <div className="text-[9px] text-muted-foreground">╪¬╪│╪¼┘è┘ä ┘ê┘å╪│╪« ┘å╪╡┘è ╪¬┘ä┘é╪º╪ª┘è</div>
        </div>
      </motion.div>
          ...
          >
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-[10px] text-muted-foreground">
                <span>╪»╪▒╪¼╪⌐ ╪º┘ä┘à┘ä╪º╪í┘à╪⌐ ┘ê╪º┘ä┘à╪╖╪º╪¿┘é╪⌐</span>
